...
def generateAllFeatures(allLandmarkCoordinates):
	...
	lmark = [17, 26, 36, 39, 42, 45, 38, 40, 44, 46, 27, 29, 32, 34, 49, 53, 48, 54, 58, 56
			, 0, 16, 3, 13, 5, 11, 7, 9, 51, 8]			# choosing the landmark positions to consider

	combinations = itertools.combinations(lmark, 4)
	# i = 0
	pointIndices1 = []
	pointIndices2 = []
	pointIndices3 = []
